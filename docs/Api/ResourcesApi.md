...
```php
getCoursesForResource($id, $limit, $starting_after, $ending_before): \Clever\Model\CoursesResponse
```
...
$apiInstance = new Clever\Api\ResourcesApi(
...
```php
getResource($id): \Clever\Model\ResourceResponse
```
...
[**\Clever\Model\ResourceResponse**](../Model/ResourceResponse.md)
...
```php
getResources($limit, $starting_after, $ending_before): \Clever\Model\ResourcesResponse
```
...
```php
getSectionsForResource($id, $limit, $starting_after, $ending_before): \Clever\Model\SectionsResponse
```
...
```php
getUsersForResource($id, $role, $limit, $starting_after, $ending_before): \Clever\Model\UsersResponse
```
